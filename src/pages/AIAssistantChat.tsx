...
import { Bot, Send, Loader2, Sparkles, Trash2, Link as LinkIcon, Palette, BarChart3, Calendar, ShoppingBag, User, Globe } from "lucide-react";
...
const AIAssistantChat = () => {
  ...
  useEffect(() => {
    const saved = sessionStorage.getItem("stl-ai-chat");
    if (saved) {
      try {
  ...
  useEffect(() => {
    if (messages.length > 0) {
      sessionStorage.setItem("stl-ai-chat", JSON.stringify(messages));
    }
  }, [messages]);
  ...
  const clearChat = () => {
    setMessages([]);
    sessionStorage.removeItem("stl-ai-chat");
  };
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Manage your profile, links, and more with AI
                </p>
              </div>
            </div>
            {messages.length > 0 && (
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            {messages.length === 0 && (
              <div className="text-center py-12">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-violet-500 to-fuchsia-500 flex items-center justify-center mx-auto mb-4 shadow-lg">
        ...
        <div className="flex-shrink-0 border-t border-border bg-card px-4 sm:px-6 py-3">
          <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
            <div className="flex items-end gap-2">
              <div className="flex-1 relative">
                <textarea
                  ...
                  placeholder="Ask me anything... (e.g., 'Add a link to my YouTube channel')"
                  rows={1}
            ...
            <p className="text-[10px] text-muted-foreground text-center mt-2">
              AI can make mistakes. Changes made by the assistant are applied instantly.
            </p>
          </form>
        </div>
      </main>
